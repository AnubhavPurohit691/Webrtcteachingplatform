        ...
        <div className="absolute top-10 left-1/2 -translate-x-1/2 h-12 min-w-lg bg-white rounded-2xl  items-center gap-2 px-4 shadow-lg flex justify-between">
          <button
            ...
            onClick={() =>
              canvas &&
              socket &&
              handleRectangle({ canvas }, socket, roomid, admin, Recording)
            }
          >
          ...
          <button
            ...
            onClick={() =>
              canvas &&
              socket &&
              handleCircle({ canvas }, socket, roomid, admin, Recording)
            }
          >
          ...
          <button
            ...
            onClick={() =>
              canvas &&
              socket &&
              handleArrow({ canvas }, socket, roomid, admin, Recording)
            }
          >
          ...
          <button
            ...
            onClick={() =>
              canvas &&
              socket &&
              handleText({ canvas }, socket, roomid, admin, Recording)
            }
          >
          ...
          <button
            ...
            onClick={() =>
              canvas &&
              socket &&
              handleEraser({ canvas }, socket, roomid, admin, Recording)
            }
          >
            <FaEraser className="w-5 h-5" />
          </button>
          <button
            className="p-2 hover:bg-gray-400 bg-red-500 text-white rounded-lg transition-colors"
            onClick={() => {
